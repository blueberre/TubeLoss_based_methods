"""configs/power.py — hyperparameters for the Protein dataset."""
import numpy as np

DATASET      = "power"
DATA_FILE    = "datasets/power.txt"
...
T            = 0.90
R            = 0.50
DELTAS       = [round(x, 3) for x in np.arange(0.000, 0.030, 0.001)]  # TODO: adjust grid if needed
