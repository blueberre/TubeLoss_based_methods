"""configs/protein.py — hyperparameters for the Protein dataset."""
import numpy as np

DATASET      = "protein"
DATA_FILE    = "datasets/protein.txt"
...
T            = 0.90
R            = 0.50
DELTAS       = [round(x, 3) for x in np.arange(0.000, 0.015, 0.001)]  # TODO: adjust grid if needed
